...
===============================================================
Purpose:
- To calculate aggregated metrics (e.g., total sales, average price) for quick insights.
- To generate a report summarizing key business metrics.

SQL Functions Used:
- COUNT(), SUM(), AVG(), DISTINCT, UNION ALL
================================================================
*/
